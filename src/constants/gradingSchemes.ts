...
export const UPES_GRADING_SCHEME: GradingScheme = {
  ...
  scale: 10,
  grades: [
    { grade: 'O',  description: 'Outstanding',    points: 10.0, minPercentage: 90 },
    { grade: 'A+', description: 'Excellent',       points: 9.0,  minPercentage: 80 },
    { grade: 'A',  description: 'Very Good',       points: 8.0,  minPercentage: 70 },
    { grade: 'B+', description: 'Good',            points: 7.0,  minPercentage: 60 },
    { grade: 'B',  description: 'Above Average',   points: 6.0,  minPercentage: 50 },
    { grade: 'C+', description: 'Average',         points: 5.0,  minPercentage: 45 },
    { grade: 'C',  description: 'Pass',            points: 4.0,  minPercentage: 40 },
